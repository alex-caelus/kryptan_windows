...
#include "Views\KeyboardPopup.g.h"
...
namespace kryptan_windows
{
    ...
    private:
        ...
        void keyboardPopup_LetterKeyDown(Platform::String^ str);
        void keyboardPopup_KeyDown(Platform::Object^ sender, Windows::UI::Xaml::Input::KeyRoutedEventArgs^ e);
    };
}
